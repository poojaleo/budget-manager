...
const ExpenseCard = (categoryName, expenseAdd, categoryBudget, onAddExpenseClick, onViewAllExpenseClick) => {
        ...
        <Card>
            <Card.Body>
                ...
                <Stack direction={"horizontal"} gap={2} className={"mt-4"}>
                    ...
                    <Button variant={"outline-danger"} onClick={onViewAllExpenseClick}>View All expenses</Button>
                </Stack>
